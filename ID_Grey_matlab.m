...
% Parameters(3).Maximum = 10000;%maximum value for the parameter
% Parameters(3).Fixed = 0;
% Parameters(4).Name = 'R2';%name of the parameter
% Parameters(4).Unit = 'Ohm';%Unit of the parameter
% Parameters(4).Value = 1+99*rand();%initial estimative for the parameter
% Parameters(4).Minimum = 1;%minimum value for the parameter
% Parameters(4).Maximum = 100;%maximum value for the parameter
% Parameters(4).Fixed = 0;
% Parameters(5).Name = 'C2';%name of the parameter
% Parameters(5).Unit = 'Faraday';%Unit of the parameter
% Parameters(5).Value = 100+9900*rand();%initial estimative for the parameter
% Parameters(5).Minimum = 100;%minimum value for the parameter
% Parameters(5).Maximum = 10000;%maximum value for the parameter
% Parameters(5).Fixed = 0;
% Parameters(6).Name = 'n';%name of the parameter
% Parameters(6).Unit = '';%Unit of the parameter
% Parameters(6).Value = rand();%initial estimative for the parameter
% Parameters(6).Minimum = 0;%minimum value for the parameter
% Parameters(6).Maximum = 1;%maximum value for the parameter
% Parameters(6).Fixed = 0;
% 
% %Initial Condition of the model
% InitialStates = [0.98;0;0];
% 
% %Handle to the model function
% func_handle = @battery_2_nrc;
% 
% nlgrmod = idnlgrey(func_handle, Order, Parameters, InitialStates);
% nlgrmod.Ts = 0;
% nlgrmod.InputName = 'Current';
